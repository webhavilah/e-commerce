...
const Featured = () => {
  ...
  return (
    <div className="">
      <Navbar />
      <div className="flex  w-[85%] bg-[#f3f3f3] m-auto mt-30 h-[400px] justify-between max-[350px]:h-70">
        <div className="w-[65%] text-[#1a1a1a] my-auto pl-10 pt-20 pb-10">
          <h2 className="text-[50px] max-[500px]:text-4xl font-bold lg:text-[50px]">Featured Products</h2>
        </div>

          <div
            className="w-[50%] h-full bg-no-repeat max-[400px]:hidden"
            style={{
