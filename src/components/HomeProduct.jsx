  ...
  return (
    <div className=" w-[80%] m-auto mt-20 h-auto pb-80">
      <div className="flex w-full justify-between">
        <h1 className="text-black font-bold text-4xl pb-7">{sectionName}</h1>
        <h2
          className="float-r font-bold text-xl underline"
          onClick={() => {
            handleScroll();
            navigate("/featured");
          }}
      ...
      <div className="grid lg:grid-cols-3 gap-5 h-70 mb-40 w-full">
        {data.map((data, id) => {
          return (
            <div
              key={id}
